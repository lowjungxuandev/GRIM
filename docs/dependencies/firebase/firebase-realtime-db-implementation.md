...
```json
{
  "uploads": {
    "upl_xyz": {
      ...
      "imageUrl": "https://minio.example.test/grim-development/uploads/upl_xyz-a1b2c3d4.jpg?X-Amz-...",
...
**Updated:** 2026-04-25
**Applies to:** grim backend Realtime Database (`backend/src/libs/firebase/realtime.ts`, `backend/package.json` -> version `0.2.4`)
**Doc version:** 4
**Upstream refs:**

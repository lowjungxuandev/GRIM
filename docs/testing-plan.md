...
The handler must wait for **Cloudinary**, image text extraction, **Step**, **Realtime Database**, and (on success) **FCM** as part of that same request (stream ends after those steps).
